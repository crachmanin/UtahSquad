...
class MyLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        # self.W = self.add_weight(shape=(input_shape[2], self.output_dim),
                                    ...
                                    # trainable=True)
        self.W = self.add_weight(shape=(None, self.output_dim,self.output_dim,),
                                    initializer='glorot_uniform',
                                    trainable=True)
...
question_net.add(MyLayer(EMBEDDING_DIM * 2))
...
for i in xrange(len(preds)):
    ...
    fp.write("Prediction: {}, Ground Truth: {}\n".format(pred, gt))
    fp.write("Prediction: {}, Ground Truth: {}\n\n".format(pred_str.encode('utf-8'), gt_str.encode('utf-8')))
print(correct)
print(max(preds))
