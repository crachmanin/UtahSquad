...
cont_to_query.add(AveragePooling1D(pool_length=60, stride=None, border_mode='valid'))
# maybe add sigmoid or tanh or batch norm
cont_to_query.add(Flatten())
cont_to_query.add(RepeatVector(200))
cont_to_query.add(Permute((2, 1)))
